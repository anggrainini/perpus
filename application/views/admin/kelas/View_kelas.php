...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Kelas/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Kelas"><i class="fa fa-plus"></i>  Tambah Kelas</a></div>
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                     <a href="'.base_url().'admin/Kelas/edit/?id_kelas='.$op['id_kelas'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                     &nbsp&nbsp
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'admin/Kelas/delete/?id_kelas='.$op['id_kelas'].'">
