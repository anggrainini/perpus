        ...
        <div class="container">
            <div class="left-div">
                <div class="user-settings-wrapper">
                    <ul class="nav">
                    <center><h1>SISTEM PERPUSTAKAAN <B>MTS N 4 Sleman</B></h1></center>   
                    </ul>
                </div>
            </div>
        </div>
...
<footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    &copy; 2017 Aplikom Bersama (coro developer) | By : <a href="http://www.designbootstrap.com/" target="_blank">DesignBootstrap | modify by: Coro Team</a>
                </div>
