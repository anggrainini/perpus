...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>petugas/Pinjam/Edit_pinjam" role="form">
              <div class="box-body">
                  ...
                  <div class="col-sm-5">
		               <select name="id_anggota" class="js-example-basic-single form-control" data-placeholder="Klik untuk memilih" >
                            ...
                            ?>
                              ...
                              {
                              ?>
                                <option value="<?php echo $op2['id_anggota'];?>" selected><?php echo $op2['nama'];?></option>
                              <?php 
                            }
                                if ($op2['id_anggota']!= $pinjam['id_anggota'])
                                  {?>
                                <option value="<?php echo $op2['id_anggota'];?>"><?php echo $op2['nama'];?></option>
                              <?php
                                }
                                ?>
                            <?php
