...
<div class="box box-solid box-primary">
  ...
  <div class="btn-group">
    <td>
     <div align ="left">
      <a  href="<?php echo base_url(); ?>petugas/Pinjam"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Pinjam"></i>Pinjam</a>
      <a  href="<?php echo base_url(); ?>petugas/Kembali"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Kembali</a>
      </div>
   </td>
  </div>
  </div>
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                    <a href="'.base_url().'petugas/Pinjam/View_dt_pinjam/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Detail Pinjam"><i class="fa fa-list"></i></a>
                    </div>';
                    if($op['status']==0)
                    {
                     echo 
                    ...
                    echo 
                    '<span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'petugas/delete_det/?id_pinjam='.$op['id_pinjam'].'">
                    <a class="btn btn-danger" role="button" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></a>                     
                    </span>
                    <a href="'.base_url().'petugas/Kembali/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="detail Pinjam"><i class="fa fa-share"></i></a>
                </td>
            </tr>';?>
<?php
    }
