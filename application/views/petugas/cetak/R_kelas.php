  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                     <a href="'.base_url().'petugas/Cetak/barcode_kartu/?id_kelas='.$op['id_kelas'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Print"><i class="fa fa-print"></i></a>
                </td>
            </tr>';?>
<?php
    }
