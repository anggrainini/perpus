...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>petugas/Petugas/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Petugas"><i class="fa fa-plus"></i>  Tambah Petugas</a></div>
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                     <a href="'.base_url().'petugas/Petugas/edit/?id_petugas='.$op['id_petugas'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                     &nbsp&nbsp
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'petugas/Petugas/delete/?id_petugas='.$op['id_petugas'].'">
