...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <!--div class="btn-group"><a href="<?php echo base_url(); ?>petugas/Kembali/edit"  class="btn btn-success" role="button" data-toggle="tooltip" title="Kembalikan"><i class="fa fa-plus"></i> Kembalikan Buku</a></div-->
...
<?php           }
    ...
    <td>
    <div align ="left"> <a  href="<?php echo base_url(); ?>petugas/Pinjam/vw_kembali"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Back</a></div>
  </td>
  </div>
  <div class="box-footer">
  </div><!-- box-footer -->
