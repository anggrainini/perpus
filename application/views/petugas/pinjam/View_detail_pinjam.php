...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group">
   <a href="<?php echo base_url(); ?>petugas/Pinjam/createdet"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data Detail Stok  Buku"><i class="fa fa-plus"></i>Tambah Detail Pinjam</a></div>
   <div class="btn-group">
    <a  href="<?php echo base_url(); ?>petugas/pinjam/vw_kembali"  class="btn btn-success" role="button" data-toggle="tooltip" title="Record Peminjaman"><i class="glyphicon glyphicon-file"></i>Record Peminjaman</a>
   </div>
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'petugas/Pinjam/delete_det/?id_detail_pinjam='.$op['id_detail_pinjam'].'&id_buku='.$op['id_buku'].'">
