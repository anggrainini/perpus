...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>petugas/Pinjam/createdet" role="form">
              <div class="box-body">
                 ...
                 <div class="col-sm-5">
                  <input type="text" class="form-control" name="id_buku_no" placeholder="ID Buku - nomor" >
  ...
  <div class="box-footer">
    <td>
    <div align ="Right"> <a  href="<?php echo base_url(); ?>petugas/Pinjam/View_dt_pinjam/?id_pinjam=<?php echo $pinjam['id_pinjam'];?>"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Back</a></div>
  </td>
  </div>
  <div class="box-footer">
