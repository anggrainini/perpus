...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-plus"></i> <i class="fa fa-globe"></i> Tambah Kelas</h3>
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>petugas/Kelas/create" role="form">
              <div class="box-body">
